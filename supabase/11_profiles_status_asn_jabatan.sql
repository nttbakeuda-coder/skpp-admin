...
from (values
  ...
  ('199110122025212037','Penata Layanan Operasional','PPPK'),
  ('199502132025212030','Penata Layanan Operasional','PPPK'),
  ('199803162025212031','Penata Layanan Operasional','PPPK'),
  ('199512132025212026','Penata Layanan Operasional','PPPK'),
  ('198004302025212017','Penata Layanan Operasional','PPPK'),
  ('198107262025212012','Penata Layanan Operasional','PPPK'),
  ('198206222025212022','Penata Layanan Operasional','PPPK'),
  ...
  ('200210192025062001','Analis Keuangan Pusat dan Daerah Ahli Pertama','PPPK'),
